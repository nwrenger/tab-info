...
execute if score #mode tab_info matches 0 \
    run function tab_info:display/deaths

# Kills (mode 1)
execute if score #mode tab_info matches 1 \
    run function tab_info:display/kills

# Playtime (mode 2)
execute if score #mode tab_info matches 2 \
    run function tab_info:display/playtime

# Position (mode 3)
execute if score #mode tab_info matches 3 \
    run function tab_info:display/pos

# World (mode 4)
execute if score #mode tab_info matches 4 \
    run function tab_info:display/world

# Empty (mode 5)
execute if score #mode tab_info matches 5 \
    run function tab_info:display/empty
